  ...
  return (
    <main className="flex min-h-screen bg-[#953553] flex-col items-center justify-between py-24 px-6">
          ...
          <span className='text-5xl'>though I woulda deny my most loyal and trustworthy friends challenge?</span>
              <br/>
              1 year, 132 lbs, muscular+lean, accepted, NO Girl friends (never again ngl fr)<br/>
              my challenge: 1 year, about 88lbs, lean+10%bodyFat, no Guy friends (except our teammates)<br/>
              <span className='text-5xl'>{"Forgive me & Don't worry I'm never ever making the mistake of choosing another girl over you, really ever again, I KNOW YOU'RE FAR MORE LOYAL THAN ME, INTROVERTED OWL. Basically everyday Flames reminded me the number of days you cried for me, don't ever again :("}</span>
              <br/>
